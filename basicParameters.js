...
const SensorHealthScore = (CI, VI, alpha, data, num) => {
  ...
  if (CI > marginCI.highAlarm && VI > marginVI.warning) return {score: 0, message: 'high volatility near upper threshold'};
...
const DeviceHealthScore = (CollectionSensorHealthScore, num) => SMA(CollectionSensorHealthScore,num)
